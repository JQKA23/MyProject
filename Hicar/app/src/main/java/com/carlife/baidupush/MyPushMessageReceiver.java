...
import com.carlife.main.MyApplication;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
	...
	public void onBind(final Context context, int errorCode, String appid,
		...
		MyApplication.channelId = channelId;
		if (errorCode == 0 && !mobile.equals("")) {
			// 绑定成功
			Log.d(TAG, "绑定成功");

			AjaxParams params = new AjaxParams();
			params.put("clientId", channelId);
			params.put("mobile", mobile);
			params.put("type", "1");
			FinalHttp fh = new FinalHttp();
			fh.post(Const.API_SERVICES_ADDRESS + "/UpdateBaiduClientId",
					params, new AjaxCallBack<Object>() {
						...
						public void onSuccess(Object t) {
							...
							System.out.print("" + t);
							MyApplication.isChannelIdUpdate = true;
						}
		...
		if (!TextUtils.isEmpty(customContentString)) {
			...
			try {
				...
				if (!customJson.isNull("mykey")) {
					...
					// context).setSmallIcon(com.carlife.R.drawable.icon)
					// .setTicker(myvalue)
					...
					// context, 0, m_Intent, 0);
					// notification = builder.setContentIntent(m_PendingIntent)
					// .setContentTitle(myvalue)
					// .setContentText("机不可失，火速接单").build();
