...
public class DaijiaOrderCancelActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.daijiaordercancel);
		...
		url_cancal = bd.getString("url_cancal");
		context = this;
	}
